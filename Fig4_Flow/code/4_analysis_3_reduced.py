...
labels = [
    ...
    #"Ampulla_Vivo_hCG17h_042224",  # Replaced at Kohei's request.
...
if make["summary_figs"]:
    color_names = "pink orange green red purple cyan olive blue gray".split()
    ...
    parts["cbars"].set_color("black")
    axis.grid(True)
    axis.set_xticks([1, 2, 3], labels=titles)
